...
static void rotate_roll(float x, float y, float z, float roll_deg, float *out_x, float *out_y, float *out_z) {
...
static void drawLine(uint32_t* buffer, int bufferWidth, int bufferHeight,
